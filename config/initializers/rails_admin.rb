# RailsAdmin config file. Generated on December 08, 2011 18:30
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Search Demo', 'Admin']
  ...
  # config.excluded_models = [Category, CategoryProduct, Product]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Category, CategoryProduct, Product]
  ...
  #   # Found associations:
  #     configure :categories, :has_and_belongs_to_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
  #     configure :description, :text 
  #     configure :producer_name, :string 
